...
//
// On Fri Oct  1 17:43:04 CEST 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkJ1(CLK,
  ...
  reg [15 : 0] CASE_insn67_BITS_14_TO_13_0b0_st0_0b1_dstackD_ETC__q3,
	       y_avValue_fst__h1883;
  reg [14 : 0] IF_IF_pc_EQ_0_THEN_0x6000_ELSE_ram_a_read_BITS_ETC___d61;
  reg [4 : 0] CASE_insn67_BITS_14_TO_13_0b0_dsp_0b1_dsp018_0_ETC__q4,
	      CASE_insn67_BITS_14_TO_13_0b10_rsp017_0b11_rsp_ETC__q5;
  wire [15 : 0] IF_IF_IF_pc_EQ_0_THEN_0x6000_ELSE_ram_a_read_B_ETC___d107,
		_st0__h1902,
		_st0__h2634,
		_st0__h2756,
		_st0__h2878,
		...
		insn__h767,
		x__h1027,
		y_avValue_fst__h1869;
  wire [14 : 0] _pc__h1906,
		_theResult___snd_snd__h2020,
		x__h1049,
		y_avValue_snd_snd_snd_fst__h1977,
		y_avValue_snd_snd_snd_fst__h1978;
  wire [13 : 0] x__h2056;
  wire [4 : 0] _dsp__h1239, _dsp__h2018, _dsp__h966, _rsp__h1017, _rsp__h1543;
  wire [1 : 0] insn67_BITS_1_TO_0__q1, insn67_BITS_3_TO_2__q2;
  wire st0_1_ULE_15___d86;
  ...
  // rule RL_run
  assign WILL_FIRE_RL_run = io_rsp$EMPTY_N && io_req$FULL_N ;

  // register dsp
  assign dsp$D_IN =
	     insn__h767[15] ?
	       _dsp__h966 :
	       CASE_insn67_BITS_14_TO_13_0b0_dsp_0b1_dsp018_0_ETC__q4 ;
  assign dsp$EN = WILL_FIRE_RL_run ;

  // register pc
  assign pc$D_IN = _pc__h1906 ;
  assign pc$EN = WILL_FIRE_RL_run ;
  ...
  assign rsp$D_IN =
	     (insn__h767[15] || insn__h767[14:13] == 2'b0 ||
	      insn__h767[14:13] == 2'b01) ?
	       rsp :
	       CASE_insn67_BITS_14_TO_13_0b10_rsp017_0b11_rsp_ETC__q5 ;
  assign rsp$EN = WILL_FIRE_RL_run ;

  // register st0
  assign st0$D_IN = _st0__h1902 ;
  assign st0$EN = WILL_FIRE_RL_run ;
  ...
  assign dstack$ADDR_IN = insn__h767[15] ? _dsp__h966 : _dsp__h1239 ;
  ...
  assign io_req$D_IN =
	     { !insn__h767[15] && insn__h767[14:13] == 2'b11 && insn__h767[5],
	       ...
	       _st0__h1902,
	       dstack$D_OUT_1 } ;
  assign io_req$ENQ = WILL_FIRE_RL_run && _st0__h1902[15:14] != 2'd0 ;
  ...
  assign io_rsp$DEQ =
	     WILL_FIRE_RL_run && !insn__h767[15] &&
	     insn__h767[14:13] == 2'b11 &&
	     insn__h767[11:8] == 4'd12 ;
  assign io_rsp$CLR = 1'b0 ;

  // submodule ram
  assign ram$ADDRA = _pc__h1906[14:1] ;
  assign ram$ADDRB = _st0__h1902[14:1] ;
  assign ram$DIA = 16'b1010101010101010 /* unspecified value */  ;
  assign ram$DIB = dstack$D_OUT_1 ;
  assign ram$WEA = 1'd0 ;
  assign ram$WEB =
	     !insn__h767[15] && insn__h767[14:13] == 2'b11 && insn__h767[5] ;
  assign ram$ENA = WILL_FIRE_RL_run ;
  assign ram$ENB = WILL_FIRE_RL_run && _st0__h1902[15:14] == 2'd0 ;
  ...
  assign rstack$ADDR_IN =
	     (insn__h767[14:13] == 2'b10) ? _rsp__h1017 : _rsp__h1543 ;
  ...
  // remaining internal signals
  assign IF_IF_IF_pc_EQ_0_THEN_0x6000_ELSE_ram_a_read_B_ETC___d107 =
	     (dstack$D_OUT_1 < st0) ? 16'd65535 : 16'd0 ;
  assign _dsp__h1239 =
	     dsp +
	     { {3{insn67_BITS_1_TO_0__q1[1]}}, insn67_BITS_1_TO_0__q1 } ;
  assign _dsp__h2018 = dsp - 5'd1 ;
  assign _dsp__h966 = dsp + 5'd1 ;
  assign _pc__h1906 =
	     insn__h767[15] ?
	       x__h1049 :
	       IF_IF_pc_EQ_0_THEN_0x6000_ELSE_ram_a_read_BITS_ETC___d61 ;
  ...
  assign _st0__h2634 = st0 + dstack$D_OUT_1 ;
  assign _st0__h2756 = st0 & dstack$D_OUT_1 ;
  assign _st0__h2878 = st0 | dstack$D_OUT_1 ;
  assign _st0__h3000 = st0 ^ dstack$D_OUT_1 ;
  assign _st0__h3122 = ~st0 ;
  assign _st0__h3493 =
	     st0_1_ULE_15___d86 ? dstack$D_OUT_1 >> st0[3:0] : 16'd0 ;
  assign _st0__h3664 = st0 - 16'd1 ;
  assign _st0__h3907 = (st0[15:14] == 2'd0) ? ram$DOB : io_rsp$D_OUT ;
  assign _st0__h4057 =
	     st0_1_ULE_15___d86 ? dstack$D_OUT_1 << st0[3:0] : 16'd0 ;
  assign _st0__h4228 = { 3'b0, rsp, 3'b0, dsp } ;
  assign _theResult___snd_snd__h2020 =
	     (st0 == 16'd0) ? y_avValue_snd_snd_snd_fst__h1977 : x__h1049 ;
  ...
  assign st0_1_ULE_15___d86 = st0 <= 16'd15 ;
  assign x__h1027 = { 1'd0, x__h1049 } ;
  assign x__h1049 = pc + 15'd2 ;
  assign x__h2056 = { insn__h767[12:0], 1'b0 } ;
  assign y_avValue_fst__h1869 = { 1'b0, insn__h767[14:0] } ;
  assign y_avValue_snd_snd_snd_fst__h1977 = { 1'd0, x__h2056 } ;
  assign y_avValue_snd_snd_snd_fst__h1978 =
	     insn__h767[12] ? rstack$D_OUT_1[14:0] : x__h1049 ;
  always@(insn__h767 or
	  IF_IF_IF_pc_EQ_0_THEN_0x6000_ELSE_ram_a_read_B_ETC___d107 or
	  st0 or
	  dstack$D_OUT_1 or
	  _st0__h2634 or
	  _st0__h2756 or
	  ...
	  _st0__h3493 or
	  _st0__h3664 or
	  rstack$D_OUT_1 or _st0__h3907 or _st0__h4057 or _st0__h4228)
  begin
    case (insn__h767[11:8])
      4'd0: y_avValue_fst__h1883 = st0;
      4'd1: y_avValue_fst__h1883 = dstack$D_OUT_1;
      4'd2: y_avValue_fst__h1883 = _st0__h2634;
      4'd3: y_avValue_fst__h1883 = _st0__h2756;
      4'd4: y_avValue_fst__h1883 = _st0__h2878;
      4'd5: y_avValue_fst__h1883 = _st0__h3000;
      4'd6: y_avValue_fst__h1883 = _st0__h3122;
      4'd7:
	  y_avValue_fst__h1883 = (dstack$D_OUT_1 == st0) ? 16'd65535 : 16'd0;
      4'd8:
	  y_avValue_fst__h1883 =
	      ((dstack$D_OUT_1 ^ 16'h8000) < (st0 ^ 16'h8000)) ?
		16'd65535 :
		16'd0;
      4'd9: y_avValue_fst__h1883 = _st0__h3493;
      4'd10: y_avValue_fst__h1883 = _st0__h3664;
      4'd11: y_avValue_fst__h1883 = rstack$D_OUT_1;
      4'd12: y_avValue_fst__h1883 = _st0__h3907;
      4'd13: y_avValue_fst__h1883 = _st0__h4057;
      4'd14: y_avValue_fst__h1883 = _st0__h4228;
      4'd15:
	  y_avValue_fst__h1883 =
	      IF_IF_IF_pc_EQ_0_THEN_0x6000_ELSE_ram_a_read_B_ETC___d107;
    endcase
  end
  always@(insn__h767 or st0 or dstack$D_OUT_1 or y_avValue_fst__h1883)
  begin
  ...
  always@(insn__h767 or
	  pc or
	  y_avValue_snd_snd_snd_fst__h1977 or
	  _theResult___snd_snd__h2020 or y_avValue_snd_snd_snd_fst__h1978)
  begin
    case (insn__h767[14:13])
      2'b0, 2'b10:
	  IF_IF_pc_EQ_0_THEN_0x6000_ELSE_ram_a_read_BITS_ETC___d61 =
  ...
  always@(insn__h767 or dsp or _dsp__h2018 or _dsp__h1239)
  begin
    case (insn__h767[14:13])
      2'b0, 2'b10:
	  CASE_insn67_BITS_14_TO_13_0b0_dsp_0b1_dsp018_0_ETC__q4 = dsp;
      2'b01:
	  CASE_insn67_BITS_14_TO_13_0b0_dsp_0b1_dsp018_0_ETC__q4 =
	      _dsp__h2018;
      2'b11:
  ...
  always@(insn__h767 or rsp or _rsp__h1017 or _rsp__h1543)
  begin
    case (insn__h767[14:13])
      2'b10:
	  CASE_insn67_BITS_14_TO_13_0b10_rsp017_0b11_rsp_ETC__q5 =
